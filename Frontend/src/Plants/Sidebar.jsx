...
const Sidebar = () => {
  const [accordionOpen, setAccordionOpen] = useState({});
    const Category = {
    Plants: {
      "Flower Plants": { path: "/plants/flowerplants" },
      "Indoor Plants": { path: "/plants/indoorplants" },
      "Potted Plants": { path: "/plants/pottedplants" },
      "Special Plants": { path: "/plants/specialplants" },
    },
    Pots: {
      "Plastic Pots": { path: "/pots/plasticpots" },
      "Mud Pots": { path: "/pots/mudpots" },
    },
    Fertilizers: {
      "Organic Fertilizers": { path: "/fertilizers/organicfertilizers" },
      "Chemical Fertilizers": { path: "/fertilizers/chemicalfertilizers" },
    }
  };
  ...
  return (
    <div>
      ...
      {/* Sidebar */}
      <div
        className="hs-overlay lg:block w-64 transition-all duration-300 transform bg-white border-e h-full border-gray-200 dark:bg-neutral-800 dark:border-neutral-700"
        role="dialog"
        tabIndex={-1}
        aria-label="Sidebar">
